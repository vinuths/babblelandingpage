...
import {
 ...
 const RemittanceDocs = ({ type, onBack }) => (
  <Card sx={{ mb: 4 }}>
    <CardContent>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
        <Typography variant="h6" className="compliance-header">{type} Documents</Typography>
        ...
        <Table size="small" className="compliance-table">
          <TableHead>
            <TableRow>
              ...
              <TableCell>ECR</TableCell>
              <TableCell>Paid Challan</TableCell>
