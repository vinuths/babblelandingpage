        ...
        <>
            <div className="container mt-4 backCon3">
                ...
                <div className="d-flex align-items-center justify-content-between mb-3">
                    ...
                    <h2
                        className="fw-bold flex-grow-1 text-center m-0"
                        style={{ color: "#013879" }}
                    >
                ...
                <div className="text-center mb-3">
                    <p>
                        Stay informed with the latest developments in laws,
                        regulations, and compliance requirements that impact
                        your business. Our Recent Legal Updates provide timely,
                        accurate, and easy-to-understand summaries of key legal
                        changes, helping you navigate the evolving legal
                        landscape with confidence and ensure your operations
                        remain compliant.
                    </p>
                </div>
                ...
                <div className="row mb-4 justify-content-center">
                    ...
                    <div className="col-md-6">
                        ...
                        <label
                            className="form-label fw-semibold text-center d-block"
                            htmlFor="stateFilter"
                        >
                            State:
                        </label>
