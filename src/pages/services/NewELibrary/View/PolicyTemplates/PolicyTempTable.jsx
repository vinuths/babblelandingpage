...
import { stateGets, policyTemplateLibraryPaginatedGet } from "../../../../../store/actions/otherActions";
...
const PolicyTempTable = ({ localPage, setLocalPage }) => {
    ...
    const { data, totalCount, loading } = useSelector((state) => state.policyTemplateLibraryPaginatedRed);
    ...
    useEffect(() => {
        ...
        dispatch(
            policyTemplateLibraryPaginatedGet({
                page: localPage,
                limit: pageSize,
                filters,
            })
            ...
            <div className="act-list">
                {loading ? (
                    ...
                    data.map((item) => {
                        ...
                        const shouldTruncate = item.remarks && item.remarks.length > 300;
                        const displayText = isExpanded || !shouldTruncate
                            ? item.remarks
                            : item.remarks.slice(0, 300) + "...";
                    ...
                    <div className="no-data-box">
                        <h3>No Policy Templates E-Library Available</h3>
                    </div>
                )}
            </div>
